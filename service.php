...
<body>
  ...
  <div class="container navigation" style="background: -webkit-linear-gradient(left, #3931af, #00c6ff);width: 98.85vw;height: 70px;padding-top: 10px;">
        ...
        <div class="navbar-header page-scroll">
          ...
          <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 0px;font-family: 'IBM Plex Sans', sans-serif;"><h5 style="color: white;"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp PARUL SEVASHRAM HOSPITAL</h5></a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active" style="margin-right: 40px;font-family: 'IBM Plex Sans', sans-serif;"><a href="service.php" style="color: white">ABOUT US</a></li>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                <h2 style="font-family: 'IBM Plex Sans', sans-serif;color: white">PARUL SEVASHRAM HOSPITAL</h2>
              </div>
              ...
              <div class="well well-trans" style="background:#ffffff00;color: white">
                <div class="wow fadeInRight" data-wow-delay="0.1s">
                  ...
                  <ul class="lead-list">
                    <li><span class="fa fa-check-square-o fa-2x icon-success"></span> <span class="list"><strong>Affordable monthly premium packages</strong><br /></span></li>
                    <li><span class="fa fa-check-square-o fa-2x icon-success"></span> <span class="list"><strong>Choose your favourite services</strong><br /></span></li>
                    <li><span class="fa fa-check-square-o fa-2x icon-success"></span> <span class="list"><strong>Only use friendly environment</strong><br /></span></li>
                  </ul>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.3s">
              <div class="box text-center">
                ...
                <p>
                After your appointment, follow any instructions given by your healthcare provider and schedule any follow-up appointments as needed.
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.5s">
              <div class="box text-center">
                ...
                <p>
                Choose from our list of package options, which may include different levels of care, amenities, and services based on your preferences and budget.
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.7s">
              <div class="box text-center">
                ...
                <p>
                We offer a wide range of medical services, including consultations, diagnostic tests, surgeries, and specialized treatments, all under one roof.
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
            ...
            <div class="wow fadeInUp" data-wow-delay="0.9s">
              <div class="box text-center">
                ...
                <p>
                Our team will generate a detailed diagnostic report based on the test results, including any relevant findings and recommendations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.1s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  ...
                  <p>Well-check or wellness check. Checkup.</p>
                </div>
              </div>
            </div>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.2s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  ...
                  <p>Collaborate with teams for patient care.</p>
                </div>
              </div>
            </div>
            <div class="wow fadeInRight" data-wow-delay="0.3s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  ...
                  <p>Staff, Services, including medicines management.</p>
                </div>
              </div>
            </div>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.1s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  ...
                  <p>we offer service Gyn Care without an appointment.</p>
                </div>
              </div>
            </div>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.2s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  ...
                  <p>Consider more auxiliary staff to the practice.</p>
                </div>
              </div>
            </div>
            <div class="wow fadeInRight" data-wow-delay="0.3s">
              ...
              <div class="service-box">
                ...
                <div class="service-desc">
                  ...
                  <p>Sleep includes variations in muscle tone, brain wave.</p>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4">
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="widget">
                <h5>About Parul Sevashram</h5>
                <p>
                 In addition to providing medical care, hospitals often play a role in medical research, education, and training for healthcare professionals.
                </p>
              </div>
            </div>
            <div class="wow fadeInDown" data-wow-delay="0.1s">
          ...
          <div class="col-sm-6 col-md-4">
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="widget">
                <h5>Parul Sevashram Hospital</h5>
                <p>
                Hospital are typically have specialized staff and equipment to deal with a wide range of health issues and emergencies.
                </p>
                <ul>
                  <li>
                    <span class="fa-stack fa-lg">
                  <i class="fa fa-calendar-o fa-stack-1x fa-inverse"></i>
                </span> Monday - Sunday, 24x7 Service
                  </li>
                  <li>
                    <span class="fa-stack fa-lg">
                ...
                </span> parulsevashramhospital.com
                  </li>
          ...
          <div class="col-sm-6 col-md-4">
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="widget">
                <h5>Our location</h5>
                <p>Limda Village, Waghodiya , Dist: Vadodara, Gujarat - 391760</p>
